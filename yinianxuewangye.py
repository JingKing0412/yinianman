...
# Streamlit 名字
st.title("Chronic coronary syndrome 1-year mortality predictor")
...
if st.button("Predict"):
   ...
   # st.write(f"**Probability of Class 0:** {probability_class_0:.1f}%")
    ...
    st.subheader(
        f"Based on feature values, the predicted 1-year mortality rate of chronic coronary syndrome is: **{probability_class_0:.1f}%**")
